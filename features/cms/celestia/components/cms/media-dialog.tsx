...
/**
 * Media picker: upload a new image (goes through /api/cms/upload → WebP) or
 * pick an existing asset from the library. Returns the public URL + alt text.
 */
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a new image (converted to WebP) or pick one from the library.
          </DialogDescription>
        </DialogHeader>
