...
| `--stroke` | `border-stroke` | Borders, dividers | `hsl(0 0% 15%)` | `#262626` |
...
Each member has a dedicated page with a live preview and a full prop reference — see the sidebar under **Layout & Pages**, starting at [Auth Shell](/docs/components/auth-shell) and [Page Shell](/docs/components/page-shell).
