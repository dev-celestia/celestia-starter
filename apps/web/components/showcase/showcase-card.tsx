...
export function ${title.replace(/[^a-zA-Z0-9]/g, "")}Demo() {
  ...
  const docsUrl = docsSlug
    ? `https://dev-celestia.github.io/celestia-starter/docs/components/${docsSlug}`
    : `https://dev-celestia.github.io/celestia-starter/docs/components`
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/50 px-4 py-3 sm:px-5">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          <Button
            ...
            className="h-7 gap-1 text-[11px] text-muted-foreground hover:text-foreground border border-border/40"
                  ...
                  {modalActiveTab === "preview" && (
                    <div className="hidden sm:flex items-center rounded-lg bg-muted/80 p-0.5 border border-border/60">
                      <button
                        ...
                        className={cn(
                          "flex items-center gap-1 rounded-md px-2 py-1 text-xs transition-all cursor-pointer",
                          viewport === "desktop"
                            ? "bg-background text-foreground shadow-xs font-semibold"
                            : "text-muted-foreground hover:text-foreground"
                        )}
