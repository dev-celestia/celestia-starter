...
export function DocsToc({ toc }: DocsTocProps) {
  ...
  return (
    <aside className="sticky top-20 hidden w-56 shrink-0 xl:block self-start max-h-[calc(100vh-6rem)] overflow-y-auto ps-4 py-2 scrollbar-none">
      <div className="flex flex-col gap-3 border-s border-border/60 ps-3">
