...
export const SEARCH_INDEX: SearchItem[] = [
  ...
  { title: "AI Components Overview", href: "/docs/components/ai", category: "AI Components", description: "Comprehensive suite of 54 production-ready AI primitives and agent interfaces." },
  { title: "Prompt Input", href: "/docs/components/prompt-input", category: "AI Components", description: "Rich expandable AI prompt input with file dropzones and model selector." },
  { title: "Reasoning", href: "/docs/components/reasoning", category: "AI Components", description: "Collapsible chain-of-thought accordion with thought duration timer." },
  { title: "Tool", href: "/docs/components/tool", category: "AI Components", description: "Agent tool call inspection card with dynamic inputs, outputs, and execution states." },
  { title: "Model Selector", href: "/docs/components/model-selector", category: "AI Components", description: "LLM switcher with provider logos (Anthropic, OpenAI, Google, Ollama)." },
  { title: "Plan", href: "/docs/components/plan", category: "AI Components", description: "Collapsible execution plan breakdown with active progress shimmers." },
  { title: "Task", href: "/docs/components/task", category: "AI Components", description: "Multi-step agent task progress display with status icons." },
  { title: "Sources", href: "/docs/components/sources", category: "AI Components", description: "Collapsible RAG source references panel with external links." },
  { title: "Inline Citation", href: "/docs/components/inline-citation", category: "AI Components", description: "Per-sentence footnote popover linking directly to source citations." },
  { title: "Audio Player", href: "/docs/components/audio-player", category: "AI Components", description: "AI speech synthesis audio playback bar powered by MediaChrome." },
  { title: "Speech Input", href: "/docs/components/speech-input", category: "AI Components", description: "Voice recording and speech-to-text input with waveform animation." },
  { title: "File Tree", href: "/docs/components/file-tree", category: "AI Components", description: "Interactive workspace file tree hierarchy viewer." },
  { title: "Confirmation", href: "/docs/components/confirmation", category: "AI Components", description: "Human-in-the-loop tool execution approval alert dialog." },
  { title: "Context", href: "/docs/components/context", category: "AI Components", description: "LLM context window token counter and cache utilization monitor." },
  { title: "Agent", href: "/docs/components/agent", category: "AI Components", description: "Visual AI agent profile with registered tool manifests and output schemas." },
  { title: "Artifact", href: "/docs/components/artifact", category: "AI Components", description: "Sidecar artifact container for generated documents, websites, and code." },
  { title: "Code Block", href: "/docs/components/code-block", category: "AI Components", description: "Syntax-highlighted code container powered by Shiki with copy button." },
  { title: "Terminal", href: "/docs/components/terminal", category: "AI Components", description: "Simulated terminal command executor and CLI output stream." },
  { title: "Test Results", href: "/docs/components/test-results", category: "AI Components", description: "Test suite execution breakdown with pass/fail counts." },
  { title: "Stack Trace", href: "/docs/components/stack-trace", category: "AI Components", description: "Formatted error stack trace analyzer and frame inspector." },
  { title: "Commit", href: "/docs/components/commit", category: "AI Components", description: "Git commit and code modification diff viewer for AI code generators." },
  { title: "Checkpoint", href: "/docs/components/checkpoint", category: "AI Components", description: "Checkpoint and snapshot version tracker for iterative AI generations." },
  { title: "Sandbox", href: "/docs/components/sandbox", category: "AI Components", description: "Live code execution sandbox with output viewer." },
  { title: "Schema Display", href: "/docs/components/schema-display", category: "AI Components", description: "Interactive JSON Schema explorer and validator." },
  { title: "Shimmer", href: "/docs/components/shimmer", category: "AI Components", description: "Text skeleton shimmer animation effect during streaming generation." },
  { title: "Snippet", href: "/docs/components/snippet", category: "AI Components", description: "Compact code snippet preview and one-click copy card." },
  { title: "Suggestions", href: "/docs/components/suggestion", category: "AI Components", description: "Horizontal scrollable prompt suggestions and quick action pills." },
  { title: "Toolbar", href: "/docs/components/toolbar", category: "AI Components", description: "Floating AI action toolbar for canvas and text selections." },
  { title: "Transcription", href: "/docs/components/transcription", category: "AI Components", description: "Audio transcription synchronized viewer." },
  { title: "Voice Selector", href: "/docs/components/voice-selector", category: "AI Components", description: "Voice selection dialog with audio previews and gender badges." },
  { title: "Web Preview", href: "/docs/components/web-preview", category: "AI Components", description: "Responsive viewport browser frame for previewing generated web pages." },
  { title: "JSX Preview", href: "/docs/components/jsx-preview", category: "AI Components", description: "Safe JSX string sandbox renderer for live AI UI generation." },
  { title: "Persona", href: "/docs/components/persona", category: "AI Components", description: "AI assistant persona profile badge and role indicator." },
  { title: "Queue", href: "/docs/components/queue", category: "AI Components", description: "Background job execution and generation queue monitor." },
  { title: "Environment Variables", href: "/docs/components/environment-variables", category: "AI Components", description: "Key-value environment variable editor for AI tool sandboxes." },
]
