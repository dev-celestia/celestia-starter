...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger, Badge } from "../../index";
    ...
    return (
      ...
      >
        <AccordionTrigger className="px-3 py-2 text-sm hover:no-underline">
          {typeof tool.description === "function" ? "Dynamic tool" : (tool.description ?? "No description")}
        </AccordionTrigger>
