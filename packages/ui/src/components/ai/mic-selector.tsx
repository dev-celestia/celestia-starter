import { Button, Command, CommandEmpty, CommandInput, CommandItem, CommandList, Popover, PopoverContent, PopoverTrigger } from "../../index";
...
export const MicSelectorTrigger = ({
  ...
  return (
    <PopoverTrigger render={<Button variant="outline" {...props} ref={ref}>{children}<CaretUpDownIcon className="shrink-0 text-muted-foreground" size={16} /></Button>} />
  );
};
