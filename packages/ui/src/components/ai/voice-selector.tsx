import { Button, Command, CommandDialog, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandSeparator, CommandShortcut, Dialog, DialogContent, DialogTitle, DialogTrigger, Spinner as SpinnerIcon } from "../../index";
...
export const VoiceSelector = ({
  ...
  return (
    <VoiceSelectorContext.Provider value={voiceSelectorContext}>
      <Dialog onOpenChange={(nextOpen: boolean) => setOpen(nextOpen)} open={open} {...props}>
        {children}
      </Dialog>
