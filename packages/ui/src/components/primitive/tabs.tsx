...
function TabsIndicator({
  ...
  return (
    <TabsPrimitive.Indicator
      ...
      className={cn(
        "pointer-events-none absolute z-0 transition-[left,top,width,height] duration-normal [transition-timing-function:cubic-bezier(0.23,1,0.32,1)] motion-reduce:transition-none",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "active:scale-[0.97] active:duration-instant motion-reduce:active:scale-100",
  ...
  return (
    <TabsPrimitive.Panel
      ...
      className={cn(
        ...
        "data-open:animate-in data-open:fade-in-0 data-open:zoom-in-[0.99] duration-normal [transition-timing-function:cubic-bezier(0.23,1,0.32,1)] motion-reduce:animate-none",
        className
      )}
      {...props}
    />
