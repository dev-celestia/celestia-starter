...
function MenubarShortcut({
  ...
  return (
    <DropdownMenuShortcut
      ...
      className={cn(
        "ms-auto text-3xs tracking-widest text-muted-foreground group-focus/menubar-item:text-accent-foreground",
        className
      )}
      {...props}
    />
